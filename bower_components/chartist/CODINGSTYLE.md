...
`<script src="chartist2image-with-canvg.js"></script>` will block the whole DOM parsing until the script has fully loaded and executed. This
...
<html>
  ...
  <body>
    ...
    <script src="chartist2image-with-canvg.js" async></script>
  </body>
</html>
```
...
<body>
  ...
  <script async src="chartist2image-with-canvg.js"></script>
</body>
</html>
```
...
<script src="chartist2image-with-canvg.js" type="text/javascript"></script>
```

**Recommended**
```
<link rel="stylesheet" href="main.css">
<script src="chartist2image-with-canvg.js"></script>
```
